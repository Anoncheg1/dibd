...
public abstract class AbstractConfig {
    ...
    public int get(final String key, final int defVal) {
    	//TODO: 1.8 return Integer.parseUnsignedInt(get(key, Integer.toString(defVal)));
    	//1.7
        return (int) Long.parseLong(get(key, Integer.toString(defVal)));
    }
     ...
     * @return
     */
    public long get(String key, final long defVal) {
